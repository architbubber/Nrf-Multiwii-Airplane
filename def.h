...
/**************************   atmega328P (Promini)  ************************************/
    ...
    #if !defined(MONGOOSE1_0)
    #if defined(NRF24_RX)
      #define BUZZERPIN_PINMODE          pinMode (2, OUTPUT);
    #else
  ...
  #if !defined(MONGOOSE1_0)
    #define SERVO_4_PINMODE            pinMode(8,OUTPUT); // 12 new       - alt TILT_ROLL
    #define SERVO_4_PIN_HIGH           PORTB |= 1<<0;
    #define SERVO_4_PIN_LOW            PORTB &= ~(1<<0);
  #endif
  #define SERVO_5_PINMODE            pinMode(5,OUTPUT); // 11 BI LEFT
  ...
  #define SERVO_6_PIN_HIGH           PORTD|= 1<<2;
  #define SERVO_6_PIN_LOW            PORTD &= ~(1<<2);
  #define SERVO_7_PINMODE            pinMode(6,OUTPUT); //10 new
